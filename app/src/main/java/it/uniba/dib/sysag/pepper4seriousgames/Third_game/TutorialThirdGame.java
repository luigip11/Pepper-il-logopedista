...
public class TutorialThirdGame extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tutorial_thirdgame);
    ...
    // Inizia il gioco = ThirdGame
    public void PlayGameActivity (View view) {
        Intent PlayGameIntent = new Intent(getApplicationContext(), ThirdGame01.class);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayFrase1 = SayBuilder.with(qiContext)
                .withText("Bene. Ti mostrerò due carte.").build();
        ...
        Say sayFrase2 = SayBuilder.with(qiContext)
                .withText("\\rspd=90\\ Ascolta la mia domanda e dimmi qual’è la carta esatta.").build();
        ...
        // SALTA LISTEN
        //Intent activityXIntent = new Intent(getApplicationContext(), ThirdGameResult.class);
        ...
        if(PhraseSetUtil.equals(matchedPhraseSet, phraseSetYes)){
            Intent activityYesIntent = new Intent(getApplicationContext(), ThirdGame01.class);
            startActivity(activityYesIntent);
        }
        else{
            Intent activityNoIntent = new Intent(getApplicationContext(), TutorialThirdGame.class);
