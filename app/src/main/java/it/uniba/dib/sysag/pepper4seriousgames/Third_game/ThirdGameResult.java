...
public class ThirdGameResult extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.third_game_result);
        ...
        mRiprova.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ThirdGameResult.this, ThirdGame01.class));
                ThirdGameResult.this.finish();
            }
        });
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayFrasefinale1 = SayBuilder.with(qiContext)
                .withText("Che bello giocare con te!").build();
