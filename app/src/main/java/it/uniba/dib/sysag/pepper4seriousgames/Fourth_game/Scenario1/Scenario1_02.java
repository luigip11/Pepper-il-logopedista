...
public class Scenario1_02 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scenario1_p02);
    ...
    public void startCorrect(){
        ...
        correctSound.start();
        Intent NextRound = new Intent(getApplicationContext(), Scenario1_03.class);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayQuestion = SayBuilder.with(qiContext).withText("Dove va il frullatore?").build(); sayQuestion.run();
        ...
        if(PhraseSetUtil.equals(matchedPhraseSet, phraseSetCorrect)){
            Say sayCorrect = SayBuilder.with(qiContext)
                    .withText("Sì! Il frullatore va in cucina!").build();
            sayCorrect.run();
            ...
            startActivity(NextRound);
                ...
                .withText("Attenzione! Il frullatore non va in bagno!").build();
            sayIncorrect.run();
