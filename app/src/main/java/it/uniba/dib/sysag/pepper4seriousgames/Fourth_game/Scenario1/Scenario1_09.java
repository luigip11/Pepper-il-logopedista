...
public class Scenario1_09 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scenario1_p09);
    ...
    public void startCorrect(){
        ...
        correctSound.start();
        Intent NextRound = new Intent(getApplicationContext(), Scenario1_10.class);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayQuestion = SayBuilder.with(qiContext).withText("Dove va il sapone?").build(); sayQuestion.run();
        ...
        if(PhraseSetUtil.equals(matchedPhraseSet, phraseSetCorrect)){
            Say sayCorrect = SayBuilder.with(qiContext)
                    .withText("Sì! Il sapone va in bagno!").build();
            sayCorrect.run();
            ...
            startActivity(NextRound);
                ...
                .withText("Attenzione! Il sapone non va in cucina!").build();
            sayIncorrect.run();
