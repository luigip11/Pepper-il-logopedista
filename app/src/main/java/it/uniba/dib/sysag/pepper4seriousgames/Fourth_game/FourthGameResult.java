...
public class FourthGameResult extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fourth_game_result);
        ...
        mRiprova.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(FourthGameResult.this, SelectScenario.class));
                FourthGameResult.this.finish();
            }
        });
