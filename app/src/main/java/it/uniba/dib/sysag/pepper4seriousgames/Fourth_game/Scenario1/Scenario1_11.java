...
public class Scenario1_11 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scenario1_p11);
    ...
    public void startCorrect(){
        ...
        correctSound.start();
        Intent NextRound = new Intent(getApplicationContext(), Scenario1_12.class);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayQuestion = SayBuilder.with(qiContext).withText("Dove va il tostapane?").build(); sayQuestion.run();
        ...
        if(PhraseSetUtil.equals(matchedPhraseSet, phraseSetCorrect)){
            Say sayCorrect = SayBuilder.with(qiContext)
                    .withText("Sì! Il tostapane va in cucina!").build();
            sayCorrect.run();
            ...
            startActivity(NextRound);
                ...
                .withText("Attenzione! Il tostapane non va in bagno!").build();
            sayIncorrect.run();
